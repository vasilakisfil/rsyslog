...
#[inline]
fn rsyslog_empty_msg<'a>() -> Result<rsyslog::Message<'a>, rsyslog::Error<'a>> {
...
#[inline]
fn rsyslog_small_msg<'a>() -> Result<rsyslog::Message<'a>, rsyslog::Error<'a>> {
...
#[inline]
fn rsyslog_medium_msg<'a>() -> Result<rsyslog::Message<'a>, rsyslog::Error<'a>> {
...
#[inline]
fn rsyslog_heroku_msg<'a>() -> Result<rsyslog::Message<'a>, rsyslog::Error<'a>> {
    rsyslog::Message::parse(
